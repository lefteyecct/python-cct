...
def drawBoard(board):
    ...
    # Define the borad and print it out. It is a list of 10 strings.
...
def inputPlayerChoice():
    ...
    # The player to choose X or O. Returns a list with the player’s choosing letter to be the first item, and the computer to be the second.
